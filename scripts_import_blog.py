...
def render_listing(posts: list[BlogPost], nested: bool = False, route_base: str = "blog") -> str:
    ...
    return page_shell(f"공간보감 {route_label} | 부산 인테리어 이야기", route_description, f'''<section class="hero"><div class="wrap"><div class="eyebrow">{route_eyebrow}</div><h1>공간보감 {route_label}</h1><p>네이버 블로그에 쌓아온 상담 기록과 현장 이야기를 홈페이지용으로 다시 정리합니다. 견적, 공사 과정, 지역별 사례를 차분히 볼 수 있습니다.</p><div class="actions"><a class="btn dark" href="https://intm.kr/consultation/ggbg">상담 신청</a><a class="btn" href="{NAVER_BLOG}" target="_blank" rel="noopener">네이버 블로그</a><a class="btn" href="{INSTAGRAM}" target="_blank" rel="noopener">Instagram</a></div></div></section><section><div class="wrap"><div class="toolbar"><a href="#all">전체</a><a href="#estimate">견적·상담</a><a href="#area">지역 사례</a><a href="{prefix}feed.xml">RSS</a></div><div class="posts">{cards}</div></div></section>''', canonical=canonical, prefix=prefix, posts=posts, robots=robots)
...
def render_qna_page() -> str:
    ...
    body = f'''<section class="hero"><div class="wrap"><div class="eyebrow">SEO Q&amp;A</div><h1>공간보감 인테리어 Q&amp;A</h1><p>부산 아파트 인테리어 상담 전에 자주 묻는 질문을 정리했습니다.</p><div class="actions"><a class="btn dark" href="https://intm.kr/consultation/ggbg">상담 신청</a><a class="btn" href="../guide/">준비 가이드</a></div></div></section><section><div class="wrap"><div class="posts">{faq_html}</div></div></section>'''
...
def render_author_page() -> str:
    body = f'''<section class="hero"><div class="wrap"><div class="eyebrow">AUTHOR</div><h1>백창석 · 공간보감 대표</h1><p>공간보다 사람을 먼저 보는 부산 인테리어 상담 기록을 정리합니다. 현장 경험과 고객의 생활 기준을 바탕으로 견적, 공정, 마감 선택을 설명합니다.</p><div class="actions"><a class="btn dark" href="https://intm.kr/consultation/ggbg">상담 신청</a><a class="btn" href="../../insights/">작성 글 보기</a></div></div></section><section><div class="wrap"><div class="posts"><article class="post-card"><div><span class="cat">전문 분야</span><h2>부산 아파트 인테리어·리모델링 상담</h2><p>구축 아파트, 가족 구성 변화, 반려동물, 신혼집, 대형 평형 등 생활 조건에 맞춘 공사 범위와 견적 기준을 설명합니다.</p></div></article><article class="post-card"><div><span class="cat">채널</span><h2>네이버 블로그와 홈페이지 인사이트</h2><p>네이버 블로그 원문을 기반으로 홈페이지에는 검색 가능한 요약과 기준 글을 공개합니다.</p></div></article></div></div></section>'''
